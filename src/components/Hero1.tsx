  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      >
        ...
        <div
          className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-blue-400/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center">
          <div className="max-w-4xl">
            ...
            <h1
              className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 animate-fade-in"
              style={{ animationDelay: "0.2s" }}
            >
              India's Premier{" "}
              <span className="text-blue-500">2D Animation</span> Studio
            </h1>

            <p
              className="text-lg md:text-xl text-gray-300 mb-4 animate-fade-in"
