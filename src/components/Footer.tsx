    ...
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          {/* Navigation Links */}
          <div>
            <h4 className="font-semibold text-white mb-6 font-toasty">Navigation</h4>
            <nav className="space-y-3">
              {navigationLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className="block text-gray-400 hover:text-white transition-colors duration-200 relative group font-toasty"
                >
                  {link.name}
          ...
          {/* Social & Newsletter */}
          <div>
            <h4 className="font-semibold text-white mb-6 font-toasty">Stay Connected</h4>
            ...
            <div>
              <p className="text-gray-400 mb-3 text-sm font-toasty">Get creative insights delivered to your inbox</p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-gray-500 text-sm flex items-center font-toasty">
              Built with <Heart className="h-4 w-4 mx-1 text-red-400" fill="currentColor" /> for creative excellence
            </p>
          </div>
        </div>
      </div>
